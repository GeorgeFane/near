...
contract AvaPerps {
    ...
    address constant USDC_CONTRACT_ADDRESS = 0x8Bb8186036a5d56686B66833FAB9537d63d4219c;
    ...
    string[] tokenNames = ["AVAX", "BTC", "ETH", "LINK"];
    address[] oracles = [
    ...
    function oracle_price(address oracle) internal view returns (uint256) {
        return uint256(AggregatorInterface(oracle).latestAnswer());
    }
